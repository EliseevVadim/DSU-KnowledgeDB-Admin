...
from app.config import get_model_name, get_connection_string, get_collection_name
...
model = AutoModel.from_pretrained(model_name_or_path, trust_remote_code=True, device_map=device)
